...
Performs useful actions on galil encoder files.
...
class GalilFile(object):
    ...
    def add_globals(cls, g):
        g["string_to_galil_hex"] = string_to_galil_hex
        g["galil_hex_to_string"] = galil_hex_to_string
        g["galil_hex_to_binary"] = galil_hex_to_binary
        g["round_galil"] = dmcround
